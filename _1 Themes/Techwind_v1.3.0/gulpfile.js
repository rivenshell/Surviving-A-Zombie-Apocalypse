...
// gulp.task('watch', function () {
//     gulp.watch([paths.src.scss.files, paths.src.html.files], gulp.series(['html', 'scss'], 'browsersyncReload'));
//     gulp.watch([paths.src.js.dir], gulp.series('js', 'browsersyncReload'));
//     gulp.watch([paths.src.js.pages], gulp.series('jsPages', 'browsersyncReload'));
...
//     // generate ltr  
//     return gulp
//         .src(paths.src.scss.main).pipe(sass().on('error', sass.logError))
//         .pipe(postcss())
//         .pipe(gulp.dest(paths.dist.css.dir))
//         .pipe(cleanCSS())
//         .pipe(
...
// gulp.task('build', gulp.series(gulp.parallel('clean:packageLock', 'clean:dist', 'copy:all', 'copy:libs', 'fileinclude', 'scss', 'js', 'jsPages', 'html', 'html')));
